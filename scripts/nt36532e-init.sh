...
# The no-flash controller requests this file again on resume.
...
if mkdir -p "$touch_fw_dir" &&
	...
	touch_log "installed rootfs touch firmware for resume"
else
	touch_log "ERROR: rootfs touch firmware installation failed; resume may fail"
fi
